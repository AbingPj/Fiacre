...
Route::redirect('/', '/admin/dashboard2', 301);
Route::group([
    ...
    Route::get('organization/show/{org_id}', [OrganizationController::class, 'show'])->name('organization.show');
    ...
    Route::get('api/data/getOrganization', [OrganizationController::class, 'getOrganization2'])->name('organization.getOrganization2');
    //Categories
