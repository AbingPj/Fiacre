...
class CreateSubscriptionWholesaleRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('subscription_wholesale_records', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('user_id')->unsigned();
            $table->bigInteger('subscription_wholesale_member_id')->unsigned();
    ...
    {
        Schema::dropIfExists('subscription_wholesale_records');
    }
}
