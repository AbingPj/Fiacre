...
class CreateSubscriptionSunclubRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('subscription_sunclub_records', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('user_id')->unsigned();
            $table->bigInteger('subscription_sunclub_member_id')->unsigned();
    ...
    {
        Schema::dropIfExists('subscription_sunclub_records');
    }
}
