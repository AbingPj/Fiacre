          ...
          >
            ...
            <div class="cart-item-texts flex-grow-1">
              <p>
                ...
                <span v-if="item.is_subscription == 1" >$ {{item.price}}/{{item.unit}}</span>
                <br />

                <br />

                <span v-if="item.is_subscription == 1" class="qty-options">
                  $ {{item.price}}  X  {{item.weeks}} weeks =
                </span>
                 <span v-if="item.is_subscription == 0" class="qty-options">
                  <b>qty:</b>
