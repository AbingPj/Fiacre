						...
						<div class="row">
							...
							<div class="col-md-6 p-content">
								...
								<div v-if="guest == 0 && product.is_subscription == 0" class="custom-control custom-switch pb-3">
									...
									<input v-model="product.recurring" :disabled="product.recurring_is_disabled" type="checkbox" class="custom-control-input" id="customSwitch1">
									...
									>
										<div v-if="guest == 1">
											<strong
												...
												class="text-danger"
												v-if="product.is_no_subscrition_available"
