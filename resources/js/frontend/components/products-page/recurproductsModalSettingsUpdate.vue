						...
						<div class="settings-cont settings-pickup mt-3 mb-3">
							...
							<div class="form-check form-check-inline">
								<input
									...
									id="set-pickup"
									:value="1"
									v-model="recurSettings.is_pickup"
								/>
								<label class="form-check-label" for="set-pickup"
									>For Pickup</label
								>
							</div>
							<div class="form-check form-check-inline">
								<input
									...
									v-model="recurSettings.is_pickup"
								/>
								<label class="form-check-label" for="set-delivery"
									>For Delivery</label
								>
							</div>
						</div>
						<div class="settings-cont settings-pickup mb-3">
							...
							<div class="form-check form-check-inline">
								<input
									...
									id="set-week"
									:value="1"
									v-model="recurSettings.week_schedule"
								/>
								<label class="form-check-label" for="set-week"
									>Every Week</label
								>
							</div>
							<!-- <div class="form-check form-check-inline">
		...
		methods: {
			getRecurringSettings() {
				axios
					...
					.then((res) => {
						this.recurSettings.id = res.data.id;
						this.recurSettings.is_pickup = res.data.is_pickup;
						this.recurSettings.week_schedule = res.data.selected_every_week_schedule;
						this.recurSettings.day = res.data.selected_day_of_week;
			...
			saveSettings() {
				...
				LoadingOverlay();
				axios
					.post("/updateUserRecurringSettings", {
						settings_id: this.recurSettings.id,
