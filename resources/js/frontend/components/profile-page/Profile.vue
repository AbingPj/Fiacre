              ...
              <md-card-content>
                ...
                <div v-else class="p-3">
                  ...
                  <span v-if="oraganization.org_optionc_id">
                    ...
                    <br />
                    <b
                      >{{ oraganization.org_street }} <br />
                      {{ oraganization.org_cityprov }},
                      {{ oraganization.org_state }}
                      {{ oraganization.org_zipcode }}</b
                    >
                  </span>
                  <br />
                  <br />
                  ...
                  >
                    <span v-if="oraganization.org_name"> Change </span>
