      ...
      <b-container class="py-5">
        <b-row>
          <b-col md="8">
            ...
            <b-row>
              <b-col md="3">
                <div :class="edit == true? 'border border-info p-2' : ''">
                ...
                <div :class="edit == true? 'border border-info p-2' : ''">
                  ...
                  <b-row>
                    <b-col md="4">
                      ...
                      <!-- <md-autocomplete v-model="selectedCity2" :md-options="cities2">
                      <label>City</label>
                    ...
                    >
                      ...
                      <md-field>
                        ...
                        <input v-model="user.state" name="state" type="hidden" />
                      </md-field>
                    </b-col>
                    <b-col md="4">
                      <md-field>
                ...
                <div class="row">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-3">
                            <select v-model="contactNumberType" name="contact_number_type" class="custom-select" :disabled="!edit==true" >
...
const ProfUserType = () =>
  import(/* webpackChunkName: "js/f/ProfUserType" */ "./UserTypeComponent.vue");
