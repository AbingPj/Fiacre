      ...
      <div class="modal-dialog modal-dialog-centered product-modaol-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body product-modal-body">
            <h6>
              <b>
                <i class="fas fa-exclamation-triangle mr-1"></i> Cancel Membership
              </b>
            </h6>
                ...
                <div class="col-12">
                  <div class="d-flex flex-row-reverse">
                    <button
                      ...
                      data-dismiss="modal"
                      aria-label="Close"
                      class="btn btn-sm btn-success-1 mr-1 ml-1 w-25"
                    >No</button>

                    <button
                      @click="cancellation()"
                      type="button"
                      class="btn btn-sm btn-success-2 mr-1 ml-1 w-25"
                    >Yes</button>
                  </div>
                </div>
              </div>
