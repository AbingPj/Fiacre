  ...
  <div>
    ...
    <div class="row">
      <div class="col-md-12 mt-2">
        <form id="faqsForm" name="faqsForm" @submit.prevent="save()">
          ...
          <div class="form-group">
            ...
            <textarea :value="title" id="faqs_title" name="title"></textarea>
          </div>

          <div class="form-group">
            <label for="content" class="font-weight-bold">Content</label>
            <textarea :value="content" @change="onContentChange" id="faqs_content" name="content"></textarea>
          </div>
...
export default {
  ...
  methods: {
    save() {
      ...
      let myForm = document.getElementById("faqsForm");
      let formData = new FormData(myForm);

      axios
        .post("/admin/settings/contents/faqsSubmit", formData, {
          headers: {
