  ...
  <div class="row">
    <div class="col-12">
      <h3>
        ...
        <download-excel :footer="['total Orders: ' + data.length ]" :header="'Porducts Orders Daily Report ('+dateLabel.replace(/,/g, '.') +')'" class="btn btn-success float-right mr-2" :fields="json_fields" :data="data" type="xls" name="podaily.xls" worksheet="Daily">
          <i class="fas fa-file-excel"></i>
          XLS
        </download-excel>
        <download-excel :footer="['total Orders: '+ data.length ]" :header="'Porducts Orders Daily Report ('+dateLabel.replace(/,/g, '.') +')'" class="btn btn-success float-right mr-2" :fields="json_fields" :data="data" type="csv" name="podaily.csv" worksheet="Daily">
        ...
        <table class="table table-hover">
          ...
          <tbody>
            <tr v-if="data.length == 0">
              <td colspan="4" class="bg-secondary text-center">No Orders yet for {{dateLabel}}</td>
            </tr>
          ...
          <tfoot>
            <tr>
              ...
              <th></th>
              <!-- <th>
                  <span class="float-right">{{data.length}}</span>
                </th> -->
...
export default {
  ...
  methods: {
    ...
    getData() {
      axios
        .post("/admin/api/reports/productsorders/daily")
        .then(res => {
