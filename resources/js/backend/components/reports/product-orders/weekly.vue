  ...
  <div class="row">
    <div class="col-12">
      <h3>
        ...
        <download-excel :footer="['total orders: '+total_orders]" :header="'Products Orders Weekly Report ('+fromLabel.replace(/,/g, '.') +' - ' + toLabel.replace(/,/g, '.')  + ')'" class="btn btn-success float-right mr-2" :fields="json_fields" :data="data" type="xls" name="poweekly.xls" worksheet="Weekly">
          <i class="fas fa-file-excel"></i>
          XLS
        </download-excel>
        <download-excel :footer="['total orders: '+total_orders]" :header="'Products Orders Weekly Report ('+fromLabel.replace(/,/g, '.') +' - '+ toLabel.replace(/,/g, '.')  + ')'" class="btn btn-success float-right mr-2" :fields="json_fields" :data="data" type="csv" name="poweekly.csv" worksheet="Weekly">
...
export default {
  ...
  methods: {
    getData() {
      axios
        .post("/admin/api/reports/productsorders/weekly")
        .then(res => {
